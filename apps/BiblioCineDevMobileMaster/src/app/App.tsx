        ...
        >
          <View style={styles.section}>
            ...
            <Text
              ...
              role="heading"
            >
              Welcome BiblioCineDevMobileMaster 👋
            </Text>
          </View>
          <View style={styles.section}>
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx build BiblioCineDevMobileMaster
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Test
                </Text>
                ...
                >
                  nx test BiblioCineDevMobileMaster
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint BiblioCineDevMobileMaster
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p BiblioCineDevMobileMaster -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx show project BiblioCineDevMobileMaster
                </Text>
              </View>
              <View style={styles.listItem}>
                <Svg
